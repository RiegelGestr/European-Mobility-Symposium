# Let's create the complete project structure with all required files
import os
import json

# Create directory structure
directories = [
    'european-mobility-site',
    'european-mobility-site/templates', 
    'european-mobility-site/content',
    'european-mobility-site/assets',
    'european-mobility-site/assets/css',
    'european-mobility-site/assets/js', 
    'european-mobility-site/program',
    'european-mobility-site/upper_image',
    'european-mobility-site/sponsors',
    'european-mobility-site/.github',
    'european-mobility-site/.github/workflows'
]
...
# Let's create the main build.py script
...
with open('european-mobility-site/build.py', 'w') as f:
    f.write(build_script)

# Make it executable
os.chmod('european-mobility-site/build.py', 0o755)

print("Created build.py script")